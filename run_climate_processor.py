...
Run this script from the root directory to properly import the climate_processor package.
"""
...
# Ensure we can import the climate_processor package
sys.path.insert(0, str(Path(__file__).parent))

from climate_processor.climate_procesor.config import load_configuration, override_config
from climate_processor.climate_procesor.data_processor import ClimateDataProcessor
from climate_processor.utils.diagnostics import run_system_diagnostics
from climate_processor.utils.logging_utils import setup_logging
